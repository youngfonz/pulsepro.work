...
// Use env key if available (supports both pk_live_ and pk_test_), fall back to production
...
const publishableKey = envKey?.startsWith('pk_') ? envKey : PRODUCTION_CLERK_KEY
